...
DATA_PATH = '../transformed_dataset_full.csv'
OUTPUT_DIR = './model_transformed_six'
...
def load_data():
    ...
    # Use the transformed text for training
    df = df[['transformed_text', 'subreddit']]
    df = df.dropna()
...
def main():
    ...
    train_dataset = RedditDataset(
        texts=train_df['transformed_text'].tolist(),
    ...
    val_dataset = RedditDataset(
        texts=val_df['transformed_text'].tolist(),
